...
<style type="text/css">.ddd_display{display:none !important;}.navbar-nav li.menu-item{width:18.75%;}.homepages .filter-tabs ul.nav-tabs li{min-width: 33.3%;}</style>
...
?>
    ...
    <div id="navigation" class="container clearfix fixedsticky">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="padding:0;">
                        ...
                        <div class="collapse navbar-collapse <?php echo $navigation_style == 'style_1' ? '' : 'no-li-padding' ?> navbar-ex1-collapse">
								...
								?>
									...
									<li class="dropdown">
										...
										<!--<a href="#" class="dropdown-toggle" data-toggle="dropdown">
											...
											<span class="fa fa-<?php echo !is_user_logged_in() ? 'head' : 'head'; ?> green"></span>
										...
										<ul class="dropdown-menu dd-custom">
											...
											<?php if( !is_user_logged_in() && $can_login == 'yes' ):?>
												...
												<li><a href="<?php echo esc_url( coupon_register_login_url() ); ?>?q=login" class="login-button"><i class="fa fa-lock"></i> <?php _e( 'Login ', 'coupon' ); ?></a></li>

												<li><a href="<?php echo esc_url( coupon_get_permalink_by_tpl( 'page-tpl_submit_code' ) ); ?>"><i class="fa fa-coupon"></i> <?php _e( 'Submit Coupon', 'coupon' ) ?></a></li>

												<li><a href="<?php echo esc_url( coupon_register_login_url() ); ?>?q=register" class="register-button"><i class="fa fa-sign-in"></i> <?php _e( 'Register ', 'coupon' ); ?></a></li>
                                       ...
                                       <a class="dropdown-toggle dataConfirm" id=""><span class="fa fa-<?php echo !is_user_logged_in() ? 'head' : 'head'; ?> green"></span></a>
