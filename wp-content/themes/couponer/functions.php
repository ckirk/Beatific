...
if( !function_exists('coupon_scripts_styles') ){
	...
	add_action('wp_enqueue_scripts', 'coupon_scripts_styles', 2);
}

function coupon_load_color_schema(){
	/* LOAD MAIN STYLE */
	...
	ob_end_clean();
	wp_add_inline_style( 'coupon-style', $custom_css );	
}
add_action('wp_enqueue_scripts', 'coupon_load_color_schema', 4 );
