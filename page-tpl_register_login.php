				...
				if( !empty( $user_meta['confirmation_hash'] ) ){
					...
					if( $user_meta['confirmation_hash'] == $_GET['confirm'] ){
						...
						$confirmation_message = array(
							...
							'message'	=> __( 'Thanks a lot for registering, now you are a member <a href="http://beatific.co/register-login/?q=login">log in </a>!', 'coupon' ),
		...
		if( $_POST['action'] == 'register' ){
			...
			if( get_option('users_can_register') ){
				...
				if(!wp_verify_nonce($_POST['register_field'], 'register')){
					...
					$subscribe = esc_sql($_POST['subscribe']);
					...
					if(0 === count($errors)) {
						...
						update_user_meta( $new_user_id, 'subscribe', $subscribe );
					...
					if( !empty( $user ) ){
						...
						if( $user_meta['active_status'] == 'active' || empty( $user_meta['active_status'] ) ){
...

							{
							  ...
							  wp_set_current_user( $user_verify );
...
<section class="login_text">
	...
	<div class="col-md-12">
			...
			<div class="caption category-caption <?php $content = get_the_content(); echo empty( $content ) ? '' : 'bottom-margin' ?>">
				...
				<h1><?php echo ($_GET['q']==='login')?'Welcome Back.':'Join the Revolution'?></h1>
				...
				<div class="col-md-12">
						...
						?>
								...
								<div class="register clearfix">
									...
									<div class="col-md-6 caption contact-caption">

									<h1>Let's save money change lives and look magnificent.</h1>

									<h2>Every Coupon you use changes a child's life</h2>

									<div class="para"><h1>Have an account?<a href="<?php echo esc_url( coupon_register_login_url() ); ?>?q=login">sign in.</a></h1></div>
									...
									<div class="col-md-6 form register-form">
										...
										<form action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>" method="post">
										   ...
										   <fieldset>
											 ...
											 <div class="form-group">
												 ...
												 <input type="checkbox" name="subscribe" id="optionsRadios2" value="no" >

												<label for="optionsRadios2"><?php _e( 'Send me emails about deals from my favourite stores ', 'coupon' ); ?></label>												
						...
						<!-- login -->
							...
							<div class="register clearfix">
								...
								<div class="col-md-6 caption contact-caption">
									...
									<div class="para"><h1>Don't have an account?<a href="<?php echo esc_url( coupon_register_login_url() ); ?>?q=register">Join</a> the revolution</h1></div>
								...
								<div class="col-md-6 form login-form register-form">
									...
									<form action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>" method="post">
									   ...
									   <fieldset>
										  ...
										  <div class="form-group <?php echo !empty( $errors['username'] ) ? 'has-error' : ''; ?>">
											 ...
											 <input type="text" name="username" placeholder="Username" class="form-control form-control-custom">
										  ...
										  <div class="form-group  has-feedback <?php echo !empty( $errors['password'] ) ? 'has-error' : ''; ?>">
											 ...
											 <input type="password" placeholder="Password" name="password" class="form-control form-control-custom">
